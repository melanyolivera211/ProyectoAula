  ...
  ResultSet rs;
   ...
   public static java.sql.Connection getConection(){
     ...
     try{
       ...
       con = (java.sql.Connection) DriverManager.getConnection("jdbc:mysql://localhost/gastos","root","");
...
private void generarPDF(String cedula) {
 ...
 double tarifaPorKWh = 0.15; // Tarifa fija por kWh
